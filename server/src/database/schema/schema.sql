...
ALTER TABLE round_group_members ADD CONSTRAINT FK_ROUND_GROUP_MEMBERS_ROUND FOREIGN KEY (round_id) REFERENCES rounds (id) ON DELETE CASCADE;
ALTER TABLE round_group_members ADD CONSTRAINT FK_ROUND_GROUP_MEMBERS_GROUP_MEMBER FOREIGN KEY (group_member_id) REFERENCES group_members (id) ON DELETE CASCADE;
