...
CREATE TABLE `groups` (
  id CHAR(36) NOT NULL,
  name VARCHAR(191),
  created_by_device_id CHAR(36) NOT NULL,
  created_on DATETIME NOT NULL,
  INDEX IDX_GROUPS_CREATED_BY (created_by_device_id),
  PRIMARY KEY(id)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;

ALTER TABLE `groups` ADD CONSTRAINT FK_GROUPS_CREATED_BY FOREIGN KEY (created_by_device_id) REFERENCES devices (id) ON DELETE RESTRICT;
...
CREATE TABLE group_members (
  ...
  INDEX IDX_GROUP_MEMBERS_CREATED_BY (created_by_device_id),
  PRIMARY KEY(id)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
...
ALTER TABLE group_members ADD CONSTRAINT FK_GROUP_MEMBERS_CREATED_BY FOREIGN KEY (created_by_device_id) REFERENCES devices (id) ON DELETE RESTRICT;
